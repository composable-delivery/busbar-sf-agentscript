...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/main/01_languageEssentials/templateExpressions/aiAuthoringBundles/TemplateExpressions/TemplateExpressions.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/main/02_actionConfiguration/actionCallbacks/aiAuthoringBundles/ActionCallbacks/ActionCallbacks.agent"
);

recipe_test!(
    recipe_action_definitions,
    "../agent-script-recipes/force-app/main/02_actionConfiguration/actionDefinitions/aiAuthoringBundles/ActionDefinitions/ActionDefinitions.agent"
);

recipe_test!(
    recipe_action_description_overrides,
    "../agent-script-recipes/force-app/main/02_actionConfiguration/actionDescriptionOverrides/aiAuthoringBundles/ActionDescriptionOverrides/ActionDescriptionOverrides.agent"
);

recipe_test!(
    recipe_advanced_input_bindings,
    "../agent-script-recipes/force-app/main/02_actionConfiguration/advancedInputBindings/aiAuthoringBundles/AdvancedInputBindings/AdvancedInputBindings.agent"
);

recipe_test!(
    recipe_prompt_template_actions,
    "../agent-script-recipes/force-app/main/02_actionConfiguration/promptTemplateActions/aiAuthoringBundles/PromptTemplateActions/PromptTemplateActions.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/main/03_reasoningMechanics/reasoningInstructions/aiAuthoringBundles/ReasoningInstructions/ReasoningInstructions.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/advancedReasoningPatterns/aiAuthoringBundles/AdvancedReasoningPatterns/AdvancedReasoningPatterns.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/errorHandling/aiAuthoringBundles/ErrorHandling/ErrorHandling.agent"
);

recipe_test!(
    recipe_external_api_integration,
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/externalAPIIntegration/aiAuthoringBundles/ExternalAPIIntegration/ExternalAPIIntegration.agent"
);

recipe_test!(
    recipe_multi_step_workflows,
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/multiStepWorkflows/aiAuthoringBundles/MultiStepWorkflows/MultiStepWorkflows.agent"
);

recipe_test!(
    recipe_multi_topic_navigation,
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/multiTopicNavigation/aiAuthoringBundles/MultiTopicNavigation/MultiTopicNavigation.agent"
);

recipe_test!(
    recipe_simple_qa,
    "../agent-script-recipes/force-app/main/04_architecturalPatterns/simpleQA/aiAuthoringBundles/SimpleQA/SimpleQA.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/future_recipes/complexStateManagement/aiAuthoringBundles/ComplexStateManagement/ComplexStateManagement.agent"
);
...
recipe_test!(
    ...
    "../agent-script-recipes/force-app/future_recipes/contextHandling/aiAuthoringBundles/ContextHandling/ContextHandling.agent"
);

recipe_test!(
    recipe_future_customer_service_agent,
    "../agent-script-recipes/force-app/future_recipes/customerServiceAgent/aiAuthoringBundles/CustomerServiceAgent/CustomerServiceAgent.agent"
);

recipe_test!(
    recipe_future_dynamic_action_routing,
    "../agent-script-recipes/force-app/future_recipes/dynamicActionRouting/aiAuthoringBundles/DynamicActionRouting/DynamicActionRouting.agent"
);

recipe_test!(
    recipe_future_escalation_patterns,
    "../agent-script-recipes/force-app/future_recipes/escalationPatterns/aiAuthoringBundles/EscalationPatterns/EscalationPatterns.agent"
);

recipe_test!(
    recipe_future_instruction_action_references,
    "../agent-script-recipes/force-app/future_recipes/instructionActionReferences/aiAuthoringBundles/InstructionActionReferences/InstructionActionReferences.agent"
);

recipe_test!(
    recipe_future_multi_topic_orchestration,
    "../agent-script-recipes/force-app/future_recipes/multiTopicOrchestration/aiAuthoringBundles/MultiTopicOrchestration/MultiTopicOrchestration.agent"
);

recipe_test!(
    recipe_future_safety_and_guardrails,
    "../agent-script-recipes/force-app/future_recipes/safetyAndGuardrails/aiAuthoringBundles/SafetyAndGuardrails/SafetyAndGuardrails.agent"
);
